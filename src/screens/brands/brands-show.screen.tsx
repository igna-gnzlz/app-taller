...
import { useInfiniteProductosByBrand } from "@/src/hooks/useInfiniteProductosByBrand";
...
export function BrandsShowScreen() {
  const { id } = useLocalSearchParams<BrandParams>();
  const {
    data,
    hasNextPage,
    fetchNextPage,
  ...
  } = useInfiniteProductosByBrand(id);
